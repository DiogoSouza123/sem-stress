...
| **Multiplayer cooperativo híbrido** | Diferencial central futuro do Coffee Crush: a tela inicial ganha um lobby para jogadores entrarem juntos e parearem; após o pareamento, ambos vão para a seleção de fases e escolhem a fase. A partida começa com cada jogador em seu tabuleiro individual; depois de N movimentos, os dois tabuleiros se mesclam em um tabuleiro cooperativo. A partir daí, os jogadores alternam turnos, mas cada um só pode mover peças na sua própria parte do tabuleiro mesclado. A pontuação do tabuleiro compartilhado soma com a pontuação individual já conquistada; ao final, os dois jogadores precisam alcançar juntos a meta de pontos | Validar em protótipo se a transição individual → tabuleiro mesclado é clara, divertida e não quebra o ritmo do match-3. Testar como modo social opcional antes de promovê-lo para diferencial principal da marca | Lobby/matchmaking simples; sessão online sincronizada; engine determinística com serialização de estado; regras de merge de tabuleiros; UI para delimitar a área de cada jogador; reconexão/abandono; definição do valor de N por fase ou modo |
...
| Multiplayer competitivo em tempo real puro | Corrida simultânea por pontuação isolada seria cara de operar e pouco diferente de leaderboards; a aposta social passa a ser o **multiplayer cooperativo híbrido** descrito acima |
